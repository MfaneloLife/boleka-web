...
exports.generateRecommendations = exports.cleanupOldData = exports.sendMessageNotification = exports.processPayment = exports.processItemImage = void 0;
...
exports.processItemImage = functions.storage.object().onFinalize(async (object) => {
    ...
    const pathParts = filePath === null || filePath === void 0 ? void 0 : filePath.split("/");
...
exports.sendMessageNotification = functions.firestore
    ...
    try {
        ...
        const recipientId = messageData.senderId === (requestData === null || requestData === void 0 ? void 0 : requestData.requesterId)
            ? requestData === null || requestData === void 0 ? void 0 : requestData.ownerId
            : requestData === null || requestData === void 0 ? void 0 : requestData.requesterId;
        if (recipientId) {
            // Create notification
...
exports.generateRecommendations = functions.firestore
    ...
    if ((before === null || before === void 0 ? void 0 : before.preferences) !== (after === null || after === void 0 ? void 0 : after.preferences)) {
        try {
            // Get user's browsing history and preferences
            const userPreferences = (after === null || after === void 0 ? void 0 : after.preferences) || {};
            ...
            if (categories.length > 0) {
                ...
                const recommendations = recommendedItems.docs.map(doc => (Object.assign(Object.assign({ itemId: doc.id }, doc.data()), { recommendedAt: admin.firestore.FieldValue.serverTimestamp() })));
...
async function verifyPayFastPayment(paymentData) {
