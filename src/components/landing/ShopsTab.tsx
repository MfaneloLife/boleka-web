    ...
    <div className="px-4 py-6 bg-white min-h-[60vh] w-full max-w-full overflow-x-hidden">
        ...
        <>
          ...
          <div className="mt-4">
            ...
            <div className="space-y-4">
              {shops.map((shop) => (
                <div key={shop.id} className="bg-white rounded-xl border border-gray-100 p-4 hover:shadow-sm transition-shadow w-full min-w-0 overflow-hidden">
                  ...
                  {shop.featuredItems.length > 0 && (
                    <div className="w-full max-w-full overflow-x-auto scrollbar-none flex gap-3 pb-1 min-w-0">
      ...
      <div className="mt-8">
        ...
        <div className="flex flex-wrap gap-2">
          {[
            { label: "Electronics & Technology", slug: "electronics-tech" },
            { label: "Home & Garden Tools", slug: "home-garden" },
            { label: "Fashion & Beauty", slug: "clothing-fashion" },
            { label: "Sports & Fitness Kit", slug: "sports-leisure" },
            { label: "Vehicles & Trailers", slug: "vehicles-transport" },
            { label: "Books & Media", slug: "books-media" },
            { label: "Events & Catering", slug: "events-catering" },
            { label: "Camping & Outdoor", slug: "camping-outdoor" },
            { label: "Toys & Games", slug: "toys-games" },
            { label: "Local Design & Art", slug: "local-design-crafts" },
          ].map((cat) => (
            <Link
              key={cat.slug}
